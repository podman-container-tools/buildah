...
func GetBudFlags(flags *BudResults) pflag.FlagSet {
	...
	fs.BoolVar(&flags.InheritLayerAnnotations, "inherit-layer-annotations", true, "inherit the per-layer annotations from the base image or base stages.")
